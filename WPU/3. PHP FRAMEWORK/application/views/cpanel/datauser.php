                ...
                foreach ($data['tbl_user'] as $row) : ?>
                    <tr class="align-middle">
                        ...
                        <td class="text-center">
                            <a href="<?= BASEURL ?>/cpanel/ubahUser/<?= $row["id"] ?>" class="btn btn-sm btn-secondary tombolUbahData" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-id="<?= $row['id'] ?>"><i class="fas fa-key"></i></a>
